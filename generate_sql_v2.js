...
const programs = [
  {
    ...
    image_url: '/programs/v2_image5.png'
  },
  {
    ...
    image_url: '/programs/v2_image7.png'
  },
  {
  ...
  },
  {
    ...
    year: '2019 - 2020',
    sortYear: 2019,
    description: 'Memfasilitasi dan membantu TAWA Semesta, sebuah LSM Yang berbasis di Makasar Provinsi Sulawesi Selatan untuk mengembangkan rencana strategi program penggalangan dana dan ekonomi berkelanjutan.',
    category: '',
    image_url: '/placeholder.jpg'
  },
  {
  ...
  },
  {
    ...
    year: '2021',
    sortYear: 2021,
    description: 'Bersama Sumba Integrated Development ( SID) Menyusun Proposal Hibah VOICE.',
    category: '',
    image_url: '/placeholder.jpg'
  },
  {
    ...
    year: '2021',
    sortYear: 2021,
    description: 'Program ini bertujuan untuk mendukung peningkatan akses, ketersediaan, dan pemanfaatan intervensi gizi esensial bagi ibu, remaja putri, bayi, dan anak. Kegiatan difokuskan pada penguatan pelaksanaan suplementasi zat besi dan asam folat (IFA dan WIFA), distribusi Kapsul Vitamin A, pemberian Zinc dan Oralit (ORS), serta peningkatan kapasitas pelaksana program guna mendukung upaya pencegahan stunting dan perbaikan status gizi masyarakat.',
    category: 'Rp. 501.490.000',
    image_url: '/programs/v2_image8.png'
  },
  {
    ...
    image_url: '/programs/v2_image2.png'
  },
  {
  ...
  },
  {
    ...
    year: '2023',
    sortYear: 2023,
    description: 'Program ini bertujuan untuk meningkatkan kapasitas petugas program gizi dan farmasi dalam pengelolaan program suplementasi Vitamin A secara terpadu, serta memperkuat sistem manajemen rantai pasok Kapsul Vitamin A guna menjamin ketersediaan dan distribusi yang efektif hingga tingkat layanan kesehatan.',
  ...
  },
  {
    ...
    image_url: '/programs/v2_image4.png'
  },
  {
    title: 'PELITA PAUD',
    year: '2026 - 2029',
    ...
    image_url: '/programs/v2_image3.png'
  }
];

// Sort descending by year (newest first)
programs.sort((a, b) => b.sortYear - a.sortYear);

let sql = `-- Migration: 0007_update_programs_from_doc_v2
-- Replaces old programs with the updated ones from RevisiProgramuntukWebsite_07072026.docx

DELETE FROM public.marungga_programs;
...
fs.writeFileSync('db/seeders/0007_update_programs_from_doc_v2.sql', sql);
console.log('Generated SQL file: db/seeders/0007_update_programs_from_doc_v2.sql');
